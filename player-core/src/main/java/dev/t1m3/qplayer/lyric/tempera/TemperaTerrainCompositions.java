...
public final class TemperaTerrainCompositions {
    ...
    private static void chasm(TemperaCompositionContext ctx) {
        ...
        TemperaCutout.addCutField(ctx, palette.tone1, java.util.Arrays.asList(gap), 0.94f);
    ...
    private static void stepWell(TemperaCompositionContext ctx) {
        ...
        TemperaCutout.addCutField(ctx, palette.tone2, java.util.Arrays.asList(shaft), 0.94f);
    ...
    private static void pierRow(TemperaCompositionContext ctx) {
        ...
        TemperaCutout.addCutField(ctx, palette.tone1, java.util.Arrays.asList(water), 0.94f);
