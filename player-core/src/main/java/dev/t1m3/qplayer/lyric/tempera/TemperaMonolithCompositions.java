...
public final class TemperaMonolithCompositions {
    ...
    private static void pylonPair(TemperaCompositionContext ctx) {
        ...
        TemperaCutout.addCutField(ctx, palette.tone1, java.util.Arrays.asList(bay), 0.94f);
    ...
    private static void bunkerSlit(TemperaCompositionContext ctx) {
        ...
        TemperaCutout.addCutField(ctx, palette.tone1, java.util.Arrays.asList(slit), 0.94f);
    ...
    private static void buttressRun(TemperaCompositionContext ctx) {
        ...
        TemperaCutout.addCutField(ctx, palette.tone1, java.util.Arrays.asList(band), 0.94f);
    ...
    private static void voidCore(TemperaCompositionContext ctx) {
        ...
        TemperaCutout.addCutField(ctx, palette.tone3, java.util.Arrays.asList(core), 0.95f);
