...
public final class TemperaTuning {
    ...
    /**
     * qplayer 自有的「增强特效」总强度（0..1），统一缩放下面这几项：落字涟漪、边缘漏光、
     * 飘浮微粒、印刷颗粒。0 = 全部关闭，回到纯 folia 观感。用总强度而不是四个独立开关，
     * 是为了让设置页只有一个滑块——这几项是一组协调的氛围，拆开调反而容易调坏。
     */
    public float effectsIntensity = 0.6f;
    /** 是否绘制网点装饰母题。 */
    ...
    public TemperaTuning copy() {
        ...
        out.effectsIntensity = effectsIntensity;
